class ApiRoutes {
  ...
  static const String transactions = '$baseUrl/transactions/user';
  static const String paymentCreateOrder = '$baseUrl/transactions/create';
  static const String paymentVerify = '$baseUrl/transactions/verify';
}
